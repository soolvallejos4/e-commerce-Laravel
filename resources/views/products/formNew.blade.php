...
@section('main')
    <h2 class="mb-3">Publicar un Producto</h2>

    <form action="{{ route('products.processNew') }}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="mb-3">
        ...
        <button type="submit" class="btn boton">Publicar</button>
    </form>
@endsection
